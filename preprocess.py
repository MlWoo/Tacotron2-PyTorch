...
def preprocess(args, input_folders, out_dir, hparams):
    ...
    metadata = preprocessor.build_from_path(hparams, input_folders, input_txt, mel_dir, linear_dir, wav_dir, args.n_jobs, tqdm=tqdm)
...
def norm_data(args):
    ...
    supported_datasets = ['mandarin', 'mandarin_pre', 'LJSpeech-1.0', 'LJSpeech-1.1', 'M-AILABS']
...
def main():
    ...
    parser.add_argument('--input_txt', default='metadata.csv')
